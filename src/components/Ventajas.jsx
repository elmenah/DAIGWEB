...
const ventajas = [
  ...
  {
    number: '03',
    title: 'Equipo Propio Calificado',
    description: 'Contamos con soldadores calificados, operadores CNC calificados y técnicos con experiencia real en planta industrial, sin tercerizar la ejecución.',
    icon: (
      <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
