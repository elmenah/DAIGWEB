      ...
      <div className="container">
        <div className="footer-grid">
          <div className="footer-about">
            ...
            <p>
              DAIG Chile SPA — Soluciones integrales de ingeniería industrial.
              Piping, estructuras metálicas, obras civiles, modelamiento 3D y
              protección de tuberías. Mejoramos la eficiencia y seguridad
              de tus espacios de trabajo.
            </p>
          </div>
          ...
          <div className="footer-links">
            ...
            <ul>
              ...
              <li><a href="#servicios-detallados">Servicios Detallados</a></li>
              <li><a href="#contacto">Cotiza</a></li>
