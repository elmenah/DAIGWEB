      ...
      <nav className="navbar">
        <div className="container">
          ...
          <div className="navbar-contact">
            <a href="#contacto" className="navbar-contact-item">
            ...
            <a href="mailto:cotizaciones@daigchile.cl" className="navbar-contact-item">
              <div className="icon-circle">
                <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="navbar-contact-text">
                ...
                <span className="contact-value">cotizaciones@daigchile.cl</span>
              </div>
            </a>
          </div>
